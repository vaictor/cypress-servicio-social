describe("RELEASE: API infogral", () => {
    ...
    it("Alumno: GET archivos HTML y adjuntos", () => {
        ...
        cy.request({
            method: 'GET',
            url: Cypress.env('devUrl')+'api/cursos/alumnos/infogral/curso/10419/info_general',
            headers: {
    ...
    it("Alumno: GET carpetas", () => {
      ...
      cy.request({
          method: 'GET',
          url: Cypress.env('devUrl')+'api/cursos/alumnos/infogral/curso/10419/carpetas',
          headers: {
            'content-type': 'application/json',
            'Authorization': Cypress.env('jwtToken')
          }
    ...
    it("Alumno: GET comentarios", () => {
      ...
      cy.request({
          method: 'GET',
          url: Cypress.env('devUrl')+'api/cursos/alumnos/infogral/curso/10346/apartado/7/comentarios',
          headers: {
            'content-type': 'application/json',
            'Authorization': Cypress.env('jwtToken')
          }
